...
- **Pre-mint audit passed (2026-07-31):** all 95 InChIKeys and formulae recompute from their SMILES; no null/empty value in any record, metadata file or attribute; `formula`/`mw` complete 95/95. Pilot fingerprint `f66365fd5dd953fd05ca7dab309b9f9887705c3ff8480039c38855ceb0528c62` (sha256 over the 95 `.smi` + metadata pairs in ID order). NB token IDs were renumbered in this audit — see DEVLOG.
